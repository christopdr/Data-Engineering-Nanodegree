...
from operators.db_load import DBImmigrationLoadOperator, DBDemographicLoadOperator, DBAirportCodesLoadOperator, DBTemperatureLoadOperator, DBSaticLabelsLoadOperator, DBCreateStarSchemaModelOperator

from airflow.models.variable import Variable
from airflow.operators.python import PythonOperator

#sas excel file static excel file with labels definition
sas_excel_file = './data/capstone_sas_labels.xlsx' 
...
load_static_labels_data = DBSaticLabelsLoadOperator(
    ...
    dag=dag,
    redshift_conn_id="redshift",
    file_path=sas_excel_file,
    labels_map=labels_map
    #bucket_key=key_location.get("static_labels")
)

create_star_schema_model = DBCreateStarSchemaModelOperator(
    task_id='create_star_schema_model',
    dag=dag,
    redshift_conn_id="redshift",
    sql_query=''
)
...
clean_and_load_immigration_data >> create_star_schema_model
clean_and_load_demographic_data >> create_star_schema_model
clean_and_load_airport_codes_data >> create_star_schema_model
clean_and_load_temperature_data >> create_star_schema_model
load_static_labels_data >> create_star_schema_model

create_star_schema_model >> end_operator
